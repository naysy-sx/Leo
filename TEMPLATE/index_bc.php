                    ...
                    <nav class="header__menu--navigation">
                        <ul class="header__menu--wrapper d-flex">
                            ...
                            <li class="header__menu--items">
                                ...
                                <ul class="header__sub--menu">
                                    <li class="header__sub--menu__items"><a href="#!" class="header__sub--menu__link">Оплата</a></li>
                                    <li class="header__sub--menu__items"><a href="#!" class="header__sub--menu__link">Оплата долями</a></li>
                                    <li class="header__sub--menu__items"><a href="#!" class="header__sub--menu__link">Доставка</a></li>
                                    <li class="header__sub--menu__items"><a href="#!" class="header__sub--menu__link">Возврат</a></li>
                                    <li class="header__sub--menu__items"><a href="#!" class="header__sub--menu__link">Правила</a></li>
                                </ul>
                            </li>
                ...
                <div class="header__account">
                    <ul class="header__account--wrapper d-flex align-items-center">
                        <li class="header__account--items  header__account--search__items d-none d-lg-block">
                            <a class="header__account--btn search__open--btn header-icons" href="javascript:void(0)" data-offcanvas>
    ...
    <section class="shop__collection--section section--padding">
        <div class="container">
            <div class="section__heading text-center mb-40">
                <h2 class="section__heading--maintitle">Каталог</h2>
            </div>
            <div class="shop__collection--column5 swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="shop__collection--card text-center">
                            <a class="shop__collection--link" href="#!">
                                <img class="shop__collection--img" src="product_images/kostum.jpg"
                                     alt="icon-img">
                                <h3 class="shop__collection--title">Костюмы</h3>
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="shop__collection--card text-center">
                            <a class="shop__collection--link" href="#!">
                                <img class="shop__collection--img" src="product_images/kombez.jpg"
                                     alt="icon-img">
                                <h3 class="shop__collection--title">Комбинезоны</h3>
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="shop__collection--card text-center">
                            <a class="shop__collection--link" href="#!">
                                <img class="shop__collection--img" src="product_images/na_vypisky.jpg"
                                     alt="icon-img">
                                <h3 class="shop__collection--title">На выписку</h3>
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="shop__collection--card text-center">
                            <a class="shop__collection--link" href="#!">
                                <img class="shop__collection--img" src="product_images/platya.jpg"
                                     alt="icon-img">
                                <h3 class="shop__collection--title">Платья</h3>
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="shop__collection--card text-center">
                            <a class="shop__collection--link" href="#!">
                                <img class="shop__collection--img" src="product_images/body.jpg"
                                     alt="icon-img">
                                <h3 class="shop__collection--title">Боди</h3>
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="shop__collection--card text-center">
                            <a class="shop__collection--link" href="#!">
                                <img class="shop__collection--img" src="product_images/pledy.jpg"
                                     alt="icon-img">
                                <h3 class="shop__collection--title">Пледы</h3>
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="shop__collection--card text-center">
                            <a class="shop__collection--link" href="#!">
                                <img class="shop__collection--img" src="product_images/shapochki.jpg"
                                     alt="icon-img">
                                <h3 class="shop__collection--title">Шапочки</h3>
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="shop__collection--card text-center">
                            <a class="shop__collection--link" href="#!">
                                <img class="shop__collection--img" src="product_images/pinetki.jpg"
                                     alt="icon-img">
                                <h3 class="shop__collection--title">Пинетки</h3>
                            </a>
                        </div>
                    </div>
                </div>
...
<!--                    <img src="images/collage3.jpg" alt="image">-->
<!--                    <div class="image__width--text">-->
<!--                        <h2 class="image__width--text__title"></h2>-->
<!--                        <p class="image__width--text__desc"></p>-->
<!--                        <div class="image__width--text__footer">-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
<!--                <div class="image__width--text__thumbnail thumbnail2">-->
<!--                    <img src="images/collage4.jpg" alt="image">-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--        <img class="section__shape--img" src="images/collage1.jpg" alt="shape-img">-->
<!--        <img class="section__shape--img two" src="images/collage2.jpg" alt="shape-img">-->
<!--    </section>-->
    <section class="product__section section--padding ">
        <div class="container">
            <div class="section__heading text-center mb-40">
                <h2 class="section__heading--maintitle" style="font-weight: 300">Наши рекомендации</h2>
            </div>
                            ...
                            <article class="product__card">
                                ...
                                <div class="product__card--content text-center">
                                    <ul class="rating product__card--rating d-flex justify-content-center">
                                        ...
                                        <li>
                                            <span class="rating__review--text">(30 отзывов)</span>
                                        </li>
                                    </ul>
...
<!--            </div>-->
    ...
    <section class="video__banner--section position-relative section--padding pb-0">
        <img class="video__banner--section__thumbnail" src="images/w-img.jpg" alt="img">
                ...
                <div class="video__banner--inner d-flex align-items-end">
                    <div class="video__banner--content">
                        ...
                        <p class="video__banner--content__desc">
                            У нас собственное производство, где мы делаем классные вещи из натуральных материалов.
                        </p>
                        <a class="video__banner--content__btn primary__btn" href="#!">Подробнее</a>
                    </div>
                </div>
            </div>
        </div>
    </section>
    <div class="before__after--section" style="margin-top: 100px">
        <div class="container">
            <div class="section__heading text-center mb-40">
                <h2 class="section__heading--maintitle">Пример блока-сравнения</h2>
            </div>
            <div id="comparison">
                <figure>
                    <div id="handle"></div>
            ...
            <div class="feature__inner d-flex justify-content-between">
                <div class="feature__items d-flex align-items-center">
                    <div class="feature__content">
                        <h2 class="feature__content--title h3">Рассрочка</h2>
                        <p class="feature__content--desc">Удобная рассрочка от банка Тинькофф</p>
                    </div>
                </div>
                <div class="feature__items d-flex align-items-center">
                    <div class="feature__content">
                        <h2 class="feature__content--title h3">Мы на связи</h2>
                        <p class="feature__content--desc">Возможность покупки в любое время</p>
                    </div>
                </div>
                <div class="feature__items d-flex align-items-center">
                    <div class="feature__content">
                        <h2 class="feature__content--title h3">Удобная покупка</h2>
                        <p class="feature__content--desc">Покупка в один клик</p>
                    </div>
                </div>
                <div class="feature__items d-flex align-items-center">
                    <div class="feature__content">
                        <h2 class="feature__content--title h3">Доставка</h2>
                        <p class="feature__content--desc">Мы доставляем по всей России</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="main__footer section--padding">
            <div class="row ">
                    ...
                    <div class="footer__widget">
                        ...
                        <div class="footer__widget--inner">
                            ...
                            <p class="footer__widget--desc">
                                Текст слогана или описание магазина
                            </p>
                            <ul class="footer__widget--info">
                                ...
                                <li class="footer__widget--info_list">
                                    ...
                                    <a class="footer__widget--info__text" href="#!">+7 495 123-45-67</a>
                                </li>
                                <li class="footer__widget--info_list">
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title ">Наш магазин
                            <button class="footer__widget--button" aria-label="footer widget button"></button>
                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg"
                                 width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z"
                ...
                <div class="col-lg-2 col-md-5">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title ">Категории
                            <button class="footer__widget--button" aria-label="footer widget button"></button>
                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg"
                                 width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z"
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#!">Название
                                    категории</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#!">Название
                                    категории</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#!">Название
                ...
                <div class="col-lg-4 col-md-7">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title ">Подписка
                            <button class="footer__widget--button" aria-label="footer widget button"></button>
                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg"
                                 width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z"
                        ...
                        <div class="footer__widget--inner">
                            <p class="footer__widget--desc">
                                Хотите, мы сообщим о новых поступлениях?
                            </p>
                            <div class="newsletter__subscribe footer__newsletter">
                                <form class="newsletter__subscribe--form" action="#">
                                    <label>
                                        <input class="newsletter__subscribe--input" placeholder="Введите ваш e-mail"
                                               type="text">
                                    </label>
                                    <button class="newsletter__subscribe--button" type="submit">Подписаться</button>
                                </form>
                            </div>
    ...
    <div class="footer__bottom">
        <div class="container">
            <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                <p class="copyright__content mb-0"><span class="text__secondary">© 2022</span> LeoKing</p>
