        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details--info">
                    <form action="#">
                        <h2 class="product__details--info__title mb-15">Боди с логотипом из ткани "Поло"</h2>
                        <code class="product__details--info__articul">SWD0028</code>
                        <div class="product__details--info__price mb-12">
                            <span class="current__price">16 000 ₽</span>
                            <span class="old__price">26 000 ₽</span>
                        </div>

                        <div class="product__details--installment">
                          <a href="#">4 платежа по 4 000</a>
                        </div>
                      ...
                      <!--
                        ...
                        <div class="product__variant">
                            <div class="product__variant--list mb-15">
                                <fieldset class="variant__input--fieldset">
                                    <legend class="product__variant--title mb-8">Цвет:</legend>
                                    <div class="variant__color d-flex">
                                        <div class="variant__color--list">
                                            <input id="color-red5" name="color" type="radio" checked>
                                            <label
                                                class="variant__color--value"
                                                for="color-red5"
                                                title="Цвет тёмной ночи"
                                        ...
                                        <div class="variant__color--list">
                                          ...
                                          <label
                                              class="variant__color--value"
                                              for="color-red7"
                                              title="Джинсовый светлый"
                                              style="background-color: #eeebe0;"
                                          ></label>
                                        </div>
                                        <div class="variant__color--list">
                                          ...
                                          <label
                                              class="variant__color--value"
                                              for="color-red8"
                                              title="Джинсовый светло-голубой"
                                              style="background-color: #a0b1c5;"
                                          ></label>
                                        </div>
                                    </div>
                            ...
                            <div class="product__variant--list mb-20">
                                <fieldset class="variant__input--fieldset">
                                    <legend class="product__variant--title mb-8">Размер :</legend>
                                    <ul class="variant__size d-flex">
                                        <li class="variant__size--list">
                                            <input id="weight4" name="weight" type="radio" checked>
                                            <label class="variant__size--value red" for="weight4">XS<br>42</label>
                                        </li>
                                        <li class="variant__size--list">
                                            <input id="weight5" name="weight" type="radio">
                                            <label class="variant__size--value red" for="weight5">S<br>44</label>
                                        </li>
                                        <li class="variant__size--list">
                                            <input id="weight6" name="weight" type="radio" disabled>
                                            <label class="variant__size--value red" for="weight6">M<br>46</label>
                                        </li>
                                        <li class="variant__size--list" disabled>
                                            <input id="weight6" name="weight" type="radio" disabled>
                                            <label class="variant__size--value red" for="weight7">L<br>48</label>
                                        </li>
                                    </ul>
                                </fieldset>
                            </div>

                          <div class="product__variant--table-sizes">
                            ...
                            <div class="product__variant--list mb-20">
                                ...
                                <button class="variant__buy--now__btn primary__btn" type="submit">Купить в один клик</button>
                            </div>
                        </div>
                        ...
                        <div class="product__details--accordion">
                            <div class="product__details--accordion__list">
                                <details>
                                    <summary class="product__details--summary">
                                        <h2 class="product__details--summary__title">Описание
                            ...
                            <div class="product__details--accordion__list">
                                <details>
                                    <summary class="product__details--summary">
                                        <h2 class="product__details--summary__title">Характеристики
                                            <svg width="11" height="6" xmlns="http://www.w3.org/2000/svg" class="order-summary-toggle__dropdown" fill="currentColor"><path d="M.504 1.813l4.358 3.845.496.438.496-.438 4.642-4.096L9.504.438 4.862 4.534h.992L1.496.69.504 1.812z"></path></svg>
                                        </h2>
                                    </summary>
                                  <div class="product__details--summary__wrapper">
                                    <ul class="additional__info_list">
                                      <li class="additional__info_list--item">
                                        <span class="info__list--item-head"><strong>Цвет</strong></span>
                                        <span class="info__list--item-content">Black, white, blue, red, gray</span>
                                      </li>
                                      <li class="additional__info_list--item">
                                        <span class="info__list--item-head"><strong>Размеры</strong></span>
                                        <span  class="info__list--item-content">XS, S, M, L</span>
                                      </li>
                                      <li class="additional__info_list--item">
                                        <span class="info__list--item-head"><strong>Вес</strong></span>
                                        <span  class="info__list--item-content">0.1 кг.</span>
                                      </li>
                                      <li class="additional__info_list--item">
                                        <span class="info__list--item-head"><strong>Производитель</strong></span>
                                        <span class="info__list--item-content">Gadget</span>
                                      </li>
                                      <li class="additional__info_list--item">
                                        <span class="info__list--item-head"><strong>Предоставление гарантии</strong></span>
                                        <span class="info__list--item-content">10 лет</span>
                                      </li>
                                     </ul>
                                  </div>
                                </details>
                            </div>
                            <div class="product__details--accordion__list">                                <details>
                                    <summary class="product__details--summary">
                                        <h2 class="product__details--summary__title">Доставка
                                            <svg width="11" height="6" xmlns="http://www.w3.org/2000/svg" class="order-summary-toggle__dropdown" fill="currentColor"><path d="M.504 1.813l4.358 3.845.496.438.496-.438 4.642-4.096L9.504.438 4.862 4.534h.992L1.496.69.504 1.812z"></path></svg>
                                        </h2>
                                    </summary>
                                  ...
                                  <div class="product__details--summary__wrapper">
                                    ...
                                    <p>Какая то информация о доставке</p>
                                    <p>Стоимость курьерской доставки в пределах МКАД –  450 руб. Доставка осуществляется с 10:00 до 23:00 в день заказа или на следующий день, в зависимости от загруженности курьерской службы.

                                      Стоимость доставки за пределы МКАД – 500 руб. + 50 руб. за каждый км. от МКАД. Рассчитывается отдельно оператором при подтверждении заказа.

                                      Для крупногабаритных товаров стоимость доставки составляет 1 000 руб.

                                      Самовывоз из шоурума – бесплатно. Заказанный товар резервируется на два дня с момента подтверждения заказа. В случае проведения акции – на один день (в отдельных случаях бронь невозможна, уточняйте у менеджера). По прошествии данного срока заказ аннулируется.</p>
...
<section class="product__section section--padding pt-0">
    <div class="container">
        <div class="section__heading text-center mb-40">
            <h2 class="section__heading--maintitle">Рекомендуем также</h2>
        </div>
