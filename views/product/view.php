            ...
            <div class="col">
                <div class="breadcrumb__content text-center">
                    <ul class="breadcrumb__content--menu d-flex justify-content-center">
                        <li class="breadcrumb__content--menu__items"><a href="/leokingyii/public_html/index.php">Главная</a></li>
                        <li class="breadcrumb__content--menu__items"><a href="/leokingyii/public_html/index.php?r=shop">Каталог</a></li>
                        <li class="breadcrumb__content--menu__items"><span><?= htmlspecialchars($model->title) ?></span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details--info">
                    <form action="#">
                        <h2 class="product__details--info__title mb-15"><?= htmlspecialchars($model->title) ?></h2>
                        <code class="product__details--info__articul"><?= htmlspecialchars($model->articul) ?></code>
                      ...
                      <!--
                        ...
                        <div class="product__variant">
                                    ...
                                    <ul class="params-colors-list">
                                        <?php foreach ($colors as $color) : ?>
                                            ...
                                            <div class="variant__color--list">
                                                <input type="radio" name="color_<?= htmlspecialchars($model['id']) ?>" id="color_<?= htmlspecialchars($model['id']) ?>_<?= htmlspecialchars($color) ?>" data-color="<?= htmlspecialchars($color) ?>" checked>
                                                <label
                                    ...
                                    ?>
                                        <?php foreach ($formattedSizes as $key => $size) : ?>
                                            ...
                                            <li class="variant__size--list">
                                                <input type="radio" name="size_<?=htmlspecialchars($model['id'])?>" id="size_<?=htmlspecialchars($model['id'])?>_<?= $key + 1 ?>" checked>
                                                <label class="variant__size--value red" for="size_<?=htmlspecialchars($model['id'])?>_<?= $key + 1 ?>">
                                                    <?= htmlspecialchars($size) ?> СМ
                                                </label>
                                            </li>
                          ...
                          <div class="product__variant--table-sizes">
                            <a class="modal-sizes" href="#sizes">Таблица размеров</a>

                            <script>
                                document.addEventListener("DOMContentLoaded", function() {
                                    const lightbox = GLightbox({
                                        selector: '.modal-sizes',
                            ...
                            <div class="product__variant--list quantity d-flex align-items-center mb-20" id="test">
                            ...
                            <div class="product__variant--list mb-20">
                                <a class="variant__wishlist--icon mb-15" href="index.php?r=wishlist" title="Добавить в избранное">
                                    ...
                                    <div class="product__details--summary__wrapper">
                                        <div class="product__tab--content">
                                            <div class="product__tab--content__step mb-30">
                                                ...
                                                <p class="product__tab--content__desc"><?=htmlspecialchars($model['longDescription'])?></p>
                                            </div>
                                  ...
                                  <div class="product__details--summary__wrapper">
                                    <ul class="additional__info_list">
                                      <li class="additional__info_list--item">
                                        ...
                                        <span class="info__list--item-content"><?=htmlspecialchars($model['attrVals1'])?></span>
                                      </li>
                                      <li class="additional__info_list--item">
                                        <span class="info__list--item-head"><strong>Пол</strong></span>
                                        <span  class="info__list--item-content"><?=htmlspecialchars($model['attrVals3'])?></span>
                                      </li>
                                      <li class="additional__info_list--item">
                                        <span class="info__list--item-head"><strong>Размеры</strong></span>
                                        <span  class="info__list--item-content"><?=htmlspecialchars($model['attrVals2'])?></span>
                                      </li>
                                      <li class="additional__info_list--item">
                                        <span class="info__list--item-head"><strong>Вес</strong></span>
                                        <span  class="info__list--item-content"><?=htmlspecialchars($model['weight'])?> кг.</span>
                                      </li>
                                      <li class="additional__info_list--item">
                                        <span class="info__list--item-head"><strong>Сезон</strong></span>
                                        <span class="info__list--item-content"><?=htmlspecialchars($model['attrVals4'])?></span>
                                      </li>
                                      <li class="additional__info_list--item">
                                        <span class="info__list--item-head"><strong>Гарантия</strong></span>
                                        <span class="info__list--item-content">1 месяц</span>
                                      </li>
                                     </ul>
                                  </div>
                                </details>
