                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="error__content text-center">
                            <img class="error__content--img display-block mb-50" src="img/other/404-thumb.webp" alt="error-img">
                ...
                <div class="feature__inner d-flex justify-content-between">
                    <div class="feature__items d-flex align-items-center">
                        ...
                        <div class="feature__content">
                            ...
                            <p class="feature__content--desc">Бесплатная доставка заказов стоимостью свыше 10 000 р.</p>
                        </div>
                    </div>
                    <div class="feature__items d-flex align-items-center">
                        <div class="feature__icon ">  
                        ...
                        <div class="feature__content">
                            ...
                            <p class="feature__content--desc">Круглосуточная связь</p>
                        </div>
                    </div>
                    <div class="feature__items d-flex align-items-center">
                        <div class="feature__icon">  
                        ...
                        <div class="feature__content">
                            <h2 class="feature__content--title h3">100% гарантия возврата денег</h2>
                            <p class="feature__content--desc">У вас есть 30 дней на возврат</p>
                        </div>
                    </div>
                    <div class="feature__items d-flex align-items-center">
                        <div class="feature__icon">  
                        ...
                        <div class="feature__content">
                            <h2 class="feature__content--title h3">Безопасная оплата</h2>
                            <p class="feature__content--desc">Мы гарантируем безопасность платежей</p>
                        </div>
                    </div>
                </div>
            </div>
