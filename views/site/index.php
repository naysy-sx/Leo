                        ...
                        <div class="container">
                            <div class="hero__slider--content">
                                <h2 class="slider__maintitle text__primary h1 text-left font-white">
                                    <span class="-light">Хлопковая <br>нежность</span>
                                    <span class="-small">для вас и ваших детей</span>
                                </h2>
                                <div>
                                    <a class="btn main-btn" href="http://89.111.140.34/leokingyii/public_html/index.php?r=shop">
                                        смотреть каталог
                ...
                <div class="swiper-slide">                    
                    <div class="hero__slider--items">
                        ...
                        <div class="container">
                            <div class="hero__slider--content">
                                <h2 class="slider__maintitle text__primary h1 text-left font-white">
                                    <span class="-light">Тепло <br>и уют</span>
                                    <span class="-small">для самых маленьких</span>
                                </h2>
                                <div>
                                    <a class="btn main-btn" href="http://89.111.140.34/leokingyii/public_html/index.php?r=shop">
                                        смотреть каталог
                ...
                <div class="swiper-slide">                    
                    <div class="hero__slider--items">
                        ...
                        <div class="container">
                            <div class="hero__slider--content">
                                <h2 class="slider__maintitle text__primary h1 text-left font-white">
                                    <span class="-light">Цвета <br>детства</span>
                                    <span class="-small">в каждой детали</span>
                                </h2>
                                <div>
                                    <a class="btn main-btn" href="http://89.111.140.34/leokingyii/public_html/index.php?r=shop">
                                        смотреть каталог
...
<ul class="catalog-grid">
    ...
    <script>
      const bestOffer2 = new Swiper('.best-offer', {
        slidesPerView: 3,
        loop: true,
        clickable: true,
        spaceBetween: 30,
