                ...
                <div class="row mb--n30">
                    <div class="col-lg-8 col-md-8 mb-30">
                        <div class="banner__box border-radius-5 position-relative">
                            <a class="display-block" href="shop.html"><img class="banner__box--thumbnail banner_sm_height-250 border-radius-5" src="img/banner/banner18.webp" alt="banner-img">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 custom-col mb-30">
                        <div class="banner__box border-radius-5 position-relative">
                            <a class="display-block" href="shop.html"><img class="banner__box--thumbnail border-radius-5" src="img/banner/banner19.webp" alt="banner-img">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 custom-col mb-30">
                        <div class="banner__box border-radius-5 position-relative">
                            <a class="display-block" href="shop.html"><img class="banner__box--thumbnail border-radius-5" src="img/banner/banner20.webp" alt="banner-img">
                                <div class="banner__box--content__style top">
                                    <h3 class="banner__box--content__style--subtitle">Best Offer</h3>
                    ...
                    <div class="col-lg-8 col-md-8 mb-30">
                        <div class="banner__box border-radius-5 position-relative">
                            <a class="display-block" href="shop.html"><img class="banner__box--thumbnail banner_sm_height-250 border-radius-5" src="img/banner/banner21.webp" alt="banner-img">
                                <div class="banner__box--content__style middle">
                                    <h3 class="banner__box--content__style--subtitle">Flat 30% Off On Fruits</h3>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="grid__banner--left__sidebar">
                            <div class="grid__banner--thumbnail position-relative">
                                <img src="img/banner/banner22.webp" alt="banner-img">
                ...
                <div class="shop__collection--column5 swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="shop__collection--card position-relative text-center">
                                <a class="shop__collection--link" href="shop.html">
                                    <img class="shop__collection--img m-0" src="img/collection/collection7.webp" alt="icon-img">
                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card position-relative text-center">
                                <a class="shop__collection--link" href="shop.html">
                                    <img class="shop__collection--img m-0" src="img/collection/collection8.webp" alt="icon-img">
                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card position-relative text-center">
                                <a class="shop__collection--link" href="shop.html">
                                    <img class="shop__collection--img m-0" src="img/collection/collection9.webp" alt="icon-img">
                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card position-relative text-center">
                                <a class="shop__collection--link" href="shop.html">
                                    <img class="shop__collection--img m-0" src="img/collection/collection10.webp" alt="icon-img">
                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card position-relative text-center">
                                <a class="shop__collection--link" href="shop.html">
                                    <img class="shop__collection--img m-0" src="img/collection/collection11.webp" alt="icon-img">
        ...
        <section class="grid__banner--section section--padding pt-0">
            <div class="container">
                <div class="row row_sm_u_reverse align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="grid__banner--thumbnail position-relative">
                            <img src="img/banner/banner23.webp" alt="banner-img">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-5">
                            <div class="banner__fullwidth--thumbnail">
                                <img src="img/banner/banner24.webp" alt="img">
                            </div>
                        </div>
