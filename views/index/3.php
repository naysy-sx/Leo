    ...
    <main class="main__content_wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="home__three--slider__items">
                            ...
                            <div class="hero__slider--layer style3">
                                <img class="slider__layer--img" src="img/slider/home3-slider1-layer.webp" alt="slider-img">
                            </div>  
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="home__three--slider__items">
                            ...
                            <div class="hero__slider--layer style3">
                                <img class="slider__layer--img" src="img/slider/home3-slider2-layer.webp" alt="slider-img">
                            </div>  
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="home__three--slider__items">
                            ...
                            <div class="hero__slider--layer style3">
                                <img class="slider__layer--img" src="img/slider/home3-slider3-layer.webp" alt="slider-img">
                            </div>  
                        </div>
                    </div>
                </div>
                ...
                <div class="shop__collection--column5 swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="shop__collection--card text-center">
                                <a class="shop__collection--link" href="shop.html">
                                    <img class="shop__collection--img" src="img/collection/collection7.webp" alt="icon-img">
                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card text-center">
                                <a class="shop__collection--link" href="shop.html">
                                    <img class="shop__collection--img" src="img/collection/collection8.webp" alt="icon-img">
                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card text-center">
                                <a class="shop__collection--link" href="shop.html">
                                    <img class="shop__collection--img" src="img/collection/collection9.webp" alt="icon-img">
                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card text-center">
                                <a class="shop__collection--link" href="shop.html">
                                    <img class="shop__collection--img" src="img/collection/collection10.webp" alt="icon-img">
                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card text-center">
                                <a class="shop__collection--link" href="shop.html">
                                    <img class="shop__collection--img" src="img/collection/collection11.webp" alt="icon-img">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="grid__banner--thumbnail">
                            <img src="img/banner/banner13.webp" alt="banner-img">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
        ...
        <section class="grid__banner--section">
            <div class="container">
                <div class="row row_sm_u_reverse align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="grid__banner--thumbnail">
                            <img src="img/banner/banner14.webp" alt="banner-img">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row no-gutter mb--n30">
                    <div class="col-lg-6 col-md-6 col-sm-6 mb-30">
                        <div class="banner__box border-radius-5 position-relative">
                            <a class="display-block" href="shop.html"><img class="banner__box--thumbnail border-radius-5" src="img/banner/banner15.webp" alt="banner-img">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 mb-30">
                        <div class="banner__box border-radius-5 position-relative">
                            <a class="display-block" href="shop.html"><img class="banner__box--thumbnail border-radius-5" src="img/banner/banner16.webp" alt="banner-img">
        ...
        <section class="advice__banner--section section--padding pt-0">
            <div class="advice__banner--box position-relative">
                <img class="advice__banner--thumbnail height_260 border-radius-5" src="img/banner/banner-fullwidth5.webp" alt="banner">
                <div class="advice__banner--content style2">
                    <h2 class="advice__banner--title">Flat 50% Off On Fresh Jewelry</h2>
                            ...
                            <article class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="blog-details.html">
                                        <img class="blog__card--thumbnail__img" src="img/blog/blog4.webp" alt="blog-img">
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="blog__card--sidebar">
                                <article class="blog__card mb-30">
                                    <div class="blog__card--thumbnail">
                                        <a class="blog__card--thumbnail__link" href="blog-details.html">
                                            <img class="blog__card--thumbnail__img" src="img/blog/blog5.webp" alt="blog-img">
                                        </a>
                                    </div>
                                ...
                                <article class="blog__card">
                                    <div class="blog__card--thumbnail">
                                        <a class="blog__card--thumbnail__link" href="blog-details.html">
                                            <img class="blog__card--thumbnail__img" src="img/blog/blog6.webp" alt="blog-img">
                                        </a>
                                    </div>
                                    <div class="blog__card--content">
                                        <div class="blog__meta">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial__box">
                            <div class="testimonial__box--thumbnail">
                                <img src="img/other/testimonial5.webp" alt="testimonial-img">
                            </div>
            ...
            <div class="newsletter__inner d-flex newsletter__bg align-items-center justify-content-between">
                <div class="newsletter__content d-flex align-items-center">
                    <div class="newsletter__email--icon">
                        <img src="img/icon/email-icon.webp" alt="icon">
                    </div>
