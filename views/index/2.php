...
<body>
    ...
    <main class="main__content_wrapper">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="slider__content">
                                                <h2 class="slider__maintitle text__primary h1">Beauty is Whatever <br>
                                                    Brings Perfect</h2>
                                                <p class="slider__desc">50% OFF on the most popular cosmetic brands. Order all classy products today!
                                                </p>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="hero__slider--thumbnail text-right">
                                                <img class="slider__layer--img style2" src="img/slider/home2-slider1-layer.webp" alt="slider-img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="container">
                                <div class="slider__items--inner">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="hero__slider--thumbnail text-right">
                                                <img class="slider__layer--img style2" src="img/slider/home2-slider2-layer.webp" alt="slider-img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="container">
                                <div class="slider__items--inner">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="hero__slider--thumbnail text-right">
                                                <img class="slider__layer--img style2" src="img/slider/home2-slider3-layer.webp" alt="slider-img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row mb--n30">
                    <div class="col-lg-6 col-md-6 mb-30">
                        <div class="banner__box border-radius-5 position-relative">
                            <a class="display-block" href="shop.html"><img class="banner__box--thumbnail border-radius-5" src="img/banner/banner9.webp" alt="banner-img">
                    ...
                    <div class="col-lg-6 col-md-6 mb-30">
                        <div class="banner__box border-radius-5 position-relative">
                            <a class="display-block" href="shop.html"><img class="banner__box--thumbnail border-radius-5" src="img/banner/banner10.webp" alt="banner-img">
                                <div class="banner__box--content">
        ...
        <section class="advice__banner--section">
            <div class="container">
                <div class="advice__banner--box position-relative">
                    <img class="advice__banner--thumbnail height_225 border-radius-5" src="img/banner/banner11.webp" alt="banner">
                    <div class="advice__banner--content banner__flex d-flex align-items-center">
                        <div class="advice__banner--content__left">
                            ...
                            <p class="advice__banner--desc">50% OFF on the most popular cosmetic brands. Order all classy products today!
                            </p>
                        </div>
                        <a class="advice__banner--btn primary__btn" href="shop.html">SHOP NOW</a>
                    </div>
                    <img class="advice__banner--layer__img" src="img/banner/banner-layer1.webp" alt="img">
                </div>
            </div>
        </section>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <div class="video__banner--box width_100 position-relative">
                            <img class="video__box--thumbnail" src="img/banner/banner12.webp" alt="banner-img">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="video__box--content">
                            ...
                            <p class="video__box--content__desc">Discover our Bestseller Edit, the best products to restart and refresh your skincare and beauty routine.</p>
        ...
        <section class="instagram__section section--padding">
            <div class="container">
                <div class="section__heading text-center mb-40">
                    <h2 class="section__heading--maintitle">Follow <span class="text__secondary">@BeautLux</span> on instagram</h2>
                </div>
                <div class="instagram__inner instagram__swiper--activation swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position-relative">
                                <a class="instagram__thumbnail--link" target="_blank" href="https://www.instagram.com/p/CZkF3TLBTT7">
                                    <img class="instagram__thumbnail--img" src="img/other/instagram1.webp" alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position-relative">
                                <a class="instagram__thumbnail--link" target="_blank" href="https://www.instagram.com/p/CZkF3TLBTT7">
                                    <img class="instagram__thumbnail--img" src="img/other/instagram2.webp" alt="">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position-relative">
                                <a class="instagram__thumbnail--link" target="_blank" href="https://www.instagram.com/p/CZkF3TLBTT7">
                                    <img class="instagram__thumbnail--img" src="img/other/instagram3.webp" alt="">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position-relative">
                                <a class="instagram__thumbnail--link" target="_blank" href="https://www.instagram.com/p/CZkF3TLBTT7">
                                    <img class="instagram__thumbnail--img" src="img/other/instagram4.webp" alt="">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position-relative">
                                <a class="instagram__thumbnail--link" target="_blank" href="https://www.instagram.com/p/CZkF3TLBTT7">
                                    <img class="instagram__thumbnail--img" src="img/other/instagram5.webp" alt="">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="brang__logo--items">
                                <img class="brang__logo--img" src="img/logo/brand-logo1.webp" alt="brand-logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brang__logo--items">
                                <img class="brang__logo--img" src="img/logo/brand-logo2.webp" alt="brand-logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brang__logo--items">
                                <img class="brang__logo--img" src="img/logo/brand-logo3.webp" alt="brand-logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brang__logo--items">
                                <img class="brang__logo--img" src="img/logo/brand-logo4.webp" alt="brand-logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brang__logo--items">
                                <img class="brang__logo--img" src="img/logo/brand-logo5.webp" alt="brand-logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brang__logo--items">
                                <img class="brang__logo--img" src="img/logo/brand-logo6.webp" alt="brand-logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brang__logo--items">
                                <img class="brang__logo--img" src="img/logo/brand-logo7.webp" alt="brand-logo">
                            </div>
                        </div>
                    </div>
                    <div class="swiper__nav--btn swiper-button-next">
