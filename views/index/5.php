...
<body>
    ...
    <header class="header__section">
        <div class="header__topbar">
            <div class="container">
                <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                    ...
                    <div class="header__search--box__style">
                        <form class="header__search--box__form" action="#">
                            <button class="header__search--box__button" aria-label="search button">
                            ...
                            <label>
                                <input class="header__search--input__field" placeholder="Search...." type="text">
                            </label>
                        </form>
                    </div>
        ...
        <div class="main__bottom bg__secondary position__relative header__sticky d-none d-lg-block">
            <div class="container">
                <div class="header__menu menu__style--two">
    ...
    <main class="main__content_wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="home__five--slider__items">
                            ...
                            <div class="hero__slider--layer style3">
                                <img class="slider__layer--img" src="img/slider/home5-slider1-layer.webp" alt="slider-img">
                            </div>  
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="home__five--slider__items">
                            ...
                            <div class="hero__slider--layer style3">
                                <img class="slider__layer--img" src="img/slider/home5-slider2-layer.webp" alt="slider-img">
                            </div>  
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="home__five--slider__items">
                            ...
                            <div class="hero__slider--layer style3">
                                <img class="slider__layer--img" src="img/slider/home5-slider3-layer.webp" alt="slider-img">
                            </div>  
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="about__thumbnail padding__left position-relative">
                            <img src="img/other/about.webp" alt="img">
                ...
                <div class="row row_sm_u_reverse align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="about__thumbnail position-relative">
                            <img src="img/other/about2.webp" alt="img">
                            ...
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        ...
                                        <img class="product__card--thumbnail__img product__secondary--img" src="img/product/main-product/product12.webp" alt="product-img">
                                    </a>
                                    <ul class="product__card--action">
                                        <li class="product__card--action__list">
                                            <a class="product__card--action__btn" title="Quick View" data-bs-toggle="modal" data-bs-target="#examplemodal" href="javascript:void(0)">
                            ...
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        ...
                                        <img class="product__card--thumbnail__img product__secondary--img" src="img/product/main-product/product11.webp" alt="product-img">
                                    </a>
                                    <span class="product__badge">-14%</span>
                                    <ul class="product__card--action">
                                        <li class="product__card--action__list">
        ...
        <section class="collection__banner--section section--padding pt-0">
            <div class="collection__banner--box position-relative">
                <img class="collection__banner--thumbnail height_583 border-radius-5" src="img/banner/banner-fullwidth7.webp" alt="banner">
            ...
            <div class="container">
                <div class="row mb--n30">
                    <div class="col-lg-6 banner_col_left_47 col-md-6 mb-30">
                        <div class="banner__box--left__sidebar">
                            <div class="banner__box border-radius-5 position-relative mb-30">
                                <a class="display-block" href="shop.html"><img class="banner__box--thumbnail banner_sm_height-250 border-radius-5" src="img/banner/banner25.webp" alt="banner-img">
                            ...
                            <div class="banner__box border-radius-5 position-relative">
                                <a class="display-block" href="shop.html"><img class="banner__box--thumbnail banner_sm_height-250 border-radius-5" src="img/banner/banner26.webp" alt="banner-img">
                    ...
                    <div class="col-lg-6 banner_col_right_52 col-md-6 mb-30">
                        <div class="banner__box border-radius-5 position-relative">
                            <a class="display-block" href="shop.html"><img class="banner__box--thumbnail border-radius-5" src="img/banner/banner27.webp" alt="banner-img">
                            ...
                            <div class="small__product--step__inner">
                                <article class="small__product--card d-flex align-items-center">
                                    <div class="small__product--thumbnail">
                                        <a class="display-block" href="#"><img class="small__product--thumbnail__img" src="img/product/small-product/product1.webp" alt="img"></a>
                                    </div>
                                ...
                                <article class="small__product--card d-flex align-items-center">
                                    <div class="small__product--thumbnail">
                                        <a class="display-block" href="#"><img class="small__product--thumbnail__img" src="img/product/small-product/product2.webp" alt="img"></a>
                                    </div>
                                    <div class="small__product--content">
                                ...
                                <article class="small__product--card d-flex align-items-center">
                                    <div class="small__product--thumbnail">
                                        <a class="display-block" href="#"><img class="small__product--thumbnail__img" src="img/product/small-product/product3.webp" alt="img"></a>
                                    </div>
                                    <div class="small__product--content">
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="small__product--step">
                            ...
                            <div class="small__product--step__inner">
                                <article class="small__product--card d-flex align-items-center">
                                    <div class="small__product--thumbnail">
                                        <a class="display-block" href="#"><img class="small__product--thumbnail__img" src="img/product/small-product/product4.webp" alt="img"></a>
                                    </div>
                                    <div class="small__product--content">
                                ...
                                <article class="small__product--card d-flex align-items-center">
                                    <div class="small__product--thumbnail">
                                        <a class="display-block" href="#"><img class="small__product--thumbnail__img" src="img/product/small-product/product5.webp" alt="img"></a>
                                    </div>
                                    <div class="small__product--content">
                                ...
                                <article class="small__product--card d-flex align-items-center">
                                    <div class="small__product--thumbnail">
                                        <a class="display-block" href="#"><img class="small__product--thumbnail__img" src="img/product/small-product/product6.webp" alt="img"></a>
                                    </div>
                                    <div class="small__product--content">
        ...
        <div class="lookbook__banner--section">
            <div class="lookbook__banner--inner d-flex">
                <div class="lookbook__thumbnail position-relative">
                    <img src="img/banner/banner28.webp" alt="banner">
                    <div class="lookbook__box one">
                        ...
                        <div class="lookbook__product one d-flex align-items-center">
                            <div class="lookbook__product--thumbnail">
                                <a class="display-block" href="product-details.html"><img class="lookbook__product--thumbnail__img" src="img/product/small-product/product3.webp" alt="img"></a>
                            </div>
                    ...
                    <div class="lookbook__box two">
                        ...
                        <div class="lookbook__product two d-flex align-items-center">
                            <div class="lookbook__product--thumbnail">
                                <a class="display-block" href="product-details.html"><img class="lookbook__product--thumbnail__img" src="img/product/small-product/product2.webp" alt="img"></a>
                            </div>
                            <div class="lookbook__product--content">
                                <h3 class="lookbook__product--content__title"><a href="product-details.html">Z 7-8mm Freshwater</a></h3>
                                <div class="product__card--price">
                    ...
                    <div class="lookbook__box three">
                        ...
                        <div class="lookbook__product one d-flex align-items-center">
                            <div class="lookbook__product--thumbnail">
                                <a class="display-block" href="product-details.html"><img class="lookbook__product--thumbnail__img" src="img/product/small-product/product4.webp" alt="img"></a>
                            </div>
                            <div class="lookbook__product--content">
                                <h3 class="lookbook__product--content__title"><a href="product-details.html">Z 7-8mm Freshwater</a></h3>
                                <div class="product__card--price">
                    ...
                    <div class="col-lg-4 col-md-8">
                        <div class="footer__widget">
                            ...
                            <div class="footer__widget--inner">
                                ...
                                <div class="footer__payment mt-30">
