...
<body>
    ...
    <!-- End preloader -->
     ...
     <!-- Start header area -->
     <header class="header__section mb-30">
                        ...
                        <ul class="language__currency d-flex align-items-center">
                            <li class="language__currency--list">
                                <a class="language__currency--link currency__link" href="javascript:void(0)">
                                    <img class="currency__link--icon" src="img/icon/language-icon.webp" alt="currency">
                                    <span>USD</span> 
                ...
                <div class="main__header--inner d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.html">
                            <img class="main__logo--img sticky__none" src="img/logo/nav-log-white.webp" alt="logo-img">
                            <img class="main__logo--img sticky__block" src="img/logo/nav-log.webp" alt="logo-img">
                        </a></h1>
                    </div>
                    ...
                    <div class="header__account">
                        <ul class="header__account--wrapper d-flex align-items-center">
                            <li class="header__account--items  header__account--search__items d-none d-lg-block">
                                <a class="header__account--btn search__open--btn text-white" href="javascript:void(0)" data-offcanvas>
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn d-sm-2-none text-white" href="wishlist.html">
                                    <span class="header__account--btn__icon">
                                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn d-sm-2-none text-white" href="my-account.html">
                                    <span class="header__account--btn__icon">
                                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="header__account--items header__minicart--items">
                                <a class="header__account--btn minicart__open--btn text-white" href="javascript:void(0)" data-offcanvas>
                                    <span class="header__account--btn__icon">
                                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <main class="main__content_wrapper">
                ...
                <div class="row mb--n30">
                    <div class="col-lg-8  mb-30">
                        <div class="banner__box border-radius-5 position-relative">
                            <a class="display-block" href="shop.html"><img class="banner__box--thumbnail banner_sm_height-250 border-radius-5" src="img/banner/banner29.webp" alt="banner-img">
                                <div class="banner__box--content__style style__right middle">
                    ...
                    <div class="col-lg-4 mb-30">
                        <div class="banner__box--right__sidebar">
                            <div class="banner__box border-radius-5 position-relative mb-30">
                                <a class="display-block" href="shop.html"><img class="banner__box--thumbnail border-radius-5" src="img/banner/banner30.webp" alt="banner-img">
                                    <div class="banner__box--content__style middle">
                                        <h3 class="banner__box--content__style--subtitle">Best Offer</h3>
                                        <h2 class="banner__box--content__style6--title ">Gemstone <br>
                                            Cuff Bangle</h2>
                                        <span class="banner__box--content__style--btn primary__btn">SHOP NOW </span>
                                    </div>
                                </a>
                            ...
                            <div class="banner__box border-radius-5 position-relative">
                                <a class="display-block" href="shop.html"><img class="banner__box--thumbnail border-radius-5" src="img/banner/banner31.webp" alt="banner-img">
                                    <div class="banner__box--content__style style__right middle">
                                        <h3 class="banner__box--content__style--subtitle">Best Offer</h3>
                                        <h2 class="banner__box--content__style6--title ">Ribbon <br>
                                            bracelet</h2>
                                        <span class="banner__box--content__style--btn primary__btn">SHOP NOW </span>
                                    </div>
                                </a>
        ...
        <!-- Start img width text section -->
        <section class="img__width--text__section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <div class="img__width--banner">
                            <img class="border-radius-5" src="img/banner/banner32.webp" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="img__width--right__sidebar">
                            <div class="img__width--content">
                                <h2 class="img__width--content__title">Beauty is Whatever
                                    Brings Perfect</h2>
                                <p class="img__width--content__desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, there sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,  aliquip ex ea commodo consequat. </p>
                                <ul class="img__width--content__logo d-flex">
                                    <li class="img__width--logo__list">
                                        <span><img src="img/icon/icon-img1.webp" alt="icon"></span>
                                        <span class="img__width--logo__text">Feature Heading</span>
                                    </li>
                                    <li class="img__width--logo__list">
                                        <span><img src="img/icon/icon-img2.webp" alt="icon"></span>
                                        <span class="img__width--logo__text">Lighweight</span>
                                    </li>
                                    <li class="img__width--logo__list">
                                        <span><img src="img/icon/icon-img3.webp" alt="icon"></span>
                                        <span class="img__width--logo__text">Feature</span>
                                    </li>
                                    <li class="img__width--logo__list">
                                        <span><img src="img/icon/icon-img4.webp" alt="icon"></span>
                                        <span class="img__width--logo__text">Aloe Vera</span>
                                    </li>
                                    <li class="img__width--logo__list">
                                        <span><img src="img/icon/icon-img5.webp" alt="icon"></span>
                                        <span class="img__width--logo__text">Vitamin C</span>
                                    </li>
                                    <li class="img__width--logo__list">
                                        <span><img src="img/icon/icon-img6.webp" alt="icon"></span>
                                        <span class="img__width--logo__text">Smooth</span>
                                    </li>
                                </ul>  
                                <a class="img__width--btn primary__btn" href="#">SHOP NOW</a> 
                            </div>
                            <div class="banner__box img__width--banner__box border-radius-5 position-relative">
                                <a class="display-block" href="shop.html"><img class="banner__box--thumbnail height_sm_u_220 border-radius-5" src="img/banner/banner33.webp" alt="banner-img">
                                    <div class="banner__box--content__style middle">
                                        <h3 class="banner__box--content__style--subtitle">HAPPY HOURS</h3>
                                        <h2 class="banner__box--content__style--title ">Monday <br>
                                            -20%</h2>
                                        <span class="banner__box--content__style--btn primary__btn">SHOP NOW </span>
                                    </div>
                                </a>
                ...
                <div class="feature__inner d-flex justify-content-between">
                    <div class="feature__items d-flex align-items-center">
                        ...
                        <div class="feature__content">
                            <h2 class="feature__content--title h3">Бесплатная доставка</h2>
                            <p class="feature__content--desc">заказов стоимостью свыше 10 000 р.</p>
                        </div>
                    </div>
                    <div class="feature__items d-flex align-items-center">
                        <div class="feature__icon ">  
                        ...
                        <div class="feature__content">
                            <h2 class="feature__content--title h3">Поддержка 24/7</h2>
                            <p class="feature__content--desc">в любое время</p>
                        </div>
                    </div>
                    <div class="feature__items d-flex align-items-center">
                        <div class="feature__icon">  
                        ...
                        <div class="feature__content">
                            <h2 class="feature__content--title h3">100% гарантия</h2>
                            <p class="feature__content--desc">возврата денег</p>
                        </div>
                    </div>
                    <div class="feature__items d-flex align-items-center">
                        <div class="feature__icon">  
                        ...
                        <div class="feature__content">
                            <h2 class="feature__content--title h3">Мы гарантируем</h2>
                            <p class="feature__content--desc">Безопасную оплату</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row mb--n30">
                            ...
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="img/product/main-product/product9.webp" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="img/product/main-product/product16.webp" alt="product-img">
                                    </a>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="img/product/main-product/product10.webp" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="img/product/main-product/product15.webp" alt="product-img">
                                    </a>
                                    <ul class="product__card--action">
                                        <li class="product__card--action__list">
                                            <a class="product__card--action__btn" title="Quick View" data-bs-toggle="modal" data-bs-target="#examplemodal" href="javascript:void(0)">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="img/product/main-product/product11.webp" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="img/product/main-product/product14.webp" alt="product-img">
                                    </a>
                                    <span class="product__badge">-14%</span>
                                    <ul class="product__card--action">
                                        <li class="product__card--action__list">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="img/product/main-product/product12.webp" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="img/product/main-product/product13.webp" alt="product-img">
                                    </a>
                                    <ul class="product__card--action">
                                        <li class="product__card--action__list">
                                            <a class="product__card--action__btn" title="Quick View" data-bs-toggle="modal" data-bs-target="#examplemodal" href="javascript:void(0)">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="img/product/main-product/product14.webp" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="img/product/main-product/product9.webp" alt="product-img">
                                    </a>
                                    <ul class="product__card--action">
                                        <li class="product__card--action__list">
                                            <a class="product__card--action__btn" title="Quick View" data-bs-toggle="modal" data-bs-target="#examplemodal" href="javascript:void(0)">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="img/product/main-product/product15.webp" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="img/product/main-product/product10.webp" alt="product-img">
                                    </a>
                                    <span class="product__badge">-14%</span>
                                    <ul class="product__card--action">
                                        <li class="product__card--action__list">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="img/product/main-product/product13.webp" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="img/product/main-product/product14.webp" alt="product-img">
                                    </a>
                                    <span class="product__badge">-14%</span>
                                    <ul class="product__card--action">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="img/product/main-product/product16.webp" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="img/product/main-product/product10.webp" alt="product-img">
                                    </a>
                                    <ul class="product__card--action">
                                        <li class="product__card--action__list">
        ...
        <section class="countdown__banner countdown__banner--bg section--padding">
            <div class="container">
                <div class="row row_sm_reverse align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <div class="countdown__content text-center">
                            ...
                            <h3 class="countdown__content--subtitle">Winter Wellness Herbal Tea Kit</h3>
                            <div class="banner__price">
                                <span class="current__price">$190.52</span>
                                <span class="old__price"> $250.00</span>
                            </div>
                            <div class="countdown__banner--style d-flex justify-content-center" data-countdown="Sep 30, 2025 00:00:00"></div>
                            <a class="countdown__content--btn primary__btn" href="shop.html">SHOP NOW</a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="countdown__thumbnail">
                            <img src="img/banner/banner34.webp" alt="img">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <article class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="blog-details.html">
                                        <img class="blog__card--thumbnail__img" src="img/blog/blog1.webp" alt="blog-img">
                                    </a>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <article class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="blog-details.html">
                                        <img class="blog__card--thumbnail__img" src="img/blog/blog2.webp" alt="blog-img">
                                    </a>
                                </div>
                                <div class="blog__card--content">
                                    <div class="blog__meta d-flex">
                        ...
                        <div class="swiper-slide">
                            <article class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="blog-details.html">
                                        <img class="blog__card--thumbnail__img" src="img/blog/blog3.webp" alt="blog-img">
                                    </a>
                                </div>
                                <div class="blog__card--content">
                                    <div class="blog__meta d-flex">
    ...
    <footer class="footer__section footer__bg--style2">
        <div class="container">
            <div class="main__footer--style6 section--padding">
                <div class="main__footer--content text-center">
                    <div class="footer__logo">
                        <a class="footer__logo--link" href="index.html">
                            <img class="footer__logo--img" src="img/logo/nav-log.webp" alt="logo-img">
                        </a>
                    </div>
                    <ul class="social__share footer__social d-flex justify-content-center">
                    ...
                    <ul class="footer__content--menu d-flex justify-content-center">
                        <li><a class="footer__content--menu__link" href="index.html">Home</a></li>
                        <li><a class="footer__content--menu__link" href="index.html">Blog</a></li>
                        <li><a class="footer__content--menu__link" href="index.html">Pages</a></li>
                        <li><a class="footer__content--menu__link" href="index.html">Contact</a></li>
                    </ul>
        ...
        <div class="footer__bottom--style">
            <div class="container">
                <div class="footer__bottom--inenr text-center">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product/product1.webp"><img class="product__media--preview__items--img" src="img/product/big-product/product1.webp" alt="product-media-img"></a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product/product2.webp"><img class="product__media--preview__items--img" src="img/product/big-product/product2.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product/product3.webp"><img class="product__media--preview__items--img" src="img/product/big-product/product3.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product/product4.webp"><img class="product__media--preview__items--img" src="img/product/big-product/product4.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product/product5.webp"><img class="product__media--preview__items--img" src="img/product/big-product/product5.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="img/product/small-product/product1.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="img/product/small-product/product2.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="img/product/small-product/product3.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="img/product/small-product/product4.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="img/product/small-product/product5.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper__nav--btn swiper-button-next">
                                        ...
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <div class="variant__color d-flex">
                                                <div class="variant__color--list">
                                                    ...
                                                    <label class="variant__color--value red" for="color-red1" title="Red"><img class="variant__color--value__img" src="img/product/small-product/product1.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red2" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red2" title="Black"><img class="variant__color--value__img" src="img/product/small-product/product2.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red3" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red3" title="Pink"><img class="variant__color--value__img" src="img/product/small-product/product3.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red4" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red4" title="Orange"><img class="variant__color--value__img" src="img/product/small-product/product4.webp" alt="variant-color-img"></label>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
